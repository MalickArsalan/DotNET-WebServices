...
<head runat="server">
    ...
    <script type="text/javascript">
        function GetStudentById() {
            ...
            debugger;
            StudentWebService.StudentService.GetStudentById(id,
...
<body>
    <form id="form1" runat="server">
        ...
        <h1>The time below does not change, when we click Get Student button as we are doing partial page post back and not a full page postback.</h1>
